...
<div class="card">
    <h5 class="card-header ">
        <i class="fab fa-fw fa-blogger fa-lg"></i> <span > Edit Blog </span></h5>
</div>
<div class="card">
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        <div class="form-group card-body">
            <h5 class="card-title">Blog Title</h5>
                <input type="text" name="blog-title" class="form-control" placeholder="Event Title" autofocus="true" required>
        </div>
        ...
        <div class="card-body form-group border-top">
            ...
            <div >
                <input type="file" name="blog-banner" class="form-control" id="event-img-input" required="">
