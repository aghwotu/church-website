...
<head>
    ...
    <title>Login | Ugbomro Church Of Christ</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="card ">
            ...
            <div class="card-footer bg-white p-0  text-center">
                <div class="card-footer-item card-footer-item-bordered">
                    Don't have an account? <a href="register.php" class="footer-link text-secondary" style="text-decoration: underline;">Create An Account</a></div>
                <!-- <div class="card-footer-item card-footer-item-bordered">
