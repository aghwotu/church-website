...
<head>
    ...
    <title>Dashboard | Church Of Christ Ugbomro</title>
    <style type="text/css">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <!-- insert class 'active' into the <a></a> tag -->
                                <a class="nav-link" href="index.php"><i class="fas fa-fw fa-warehouse"></i>Dashboard</a>
                            </li>
                            <li class="nav-item ">
                                <!-- insert class 'active' into the <a></a> tag -->
                                <a class="nav-link" href="events.php"><i class="fas fa-fw fa-calendar-alt"></i>Events</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="sermons.php"><i class="fa fa-fw fa-book"></i>Sermons</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="blog.php"><i class="fab fa-fw fa-blogger"></i>Blog</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="sms.php"><i class="fas fa-fw fa-paper-plane"></i>SMS</a>
                            </li>
                            <li class="nav-item ">
                                <!-- insert class 'active' into the <a></a> tag -->
                                <a class="nav-link" href="users.php"><i class="fa fa-fw fa-user-circle"></i>Users</a>
                            </li>
                            <li class="nav-item ">
                                <!-- insert class 'active' into the <a></a> tag -->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © <script>document.write(new Date().getFullYear());</script> Ugbomro. All rights reserved. Developed by <a href="https://twitter.com/ediri_aghwotu">Aghwotu</a>.
                        </div>
